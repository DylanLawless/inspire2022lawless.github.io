...
% Cytokines were increased for those with ALT versus REF,  but this is also seen for strain B versus strain A.
% Values are listed as  median (lower-upper quartile): IFN$\alpha$ 9 (3-22) to 13 (4-25) and IFN$\gamma$ 3.5 (1-6.6) to  4.1 (2-7.8) in REF/ALT, respectively.
% IFN$\alpha$ 9.5 (3-22.5) to 12.6 (4.1-25.8) and  IFN$\gamma$ 3.6 (1-7) to 4 (2-7.4), Strain A/B respectively.
