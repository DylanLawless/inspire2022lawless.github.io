...
\bottomrule										
\caption{										
\textbf{Cohort characteristics of infants with persistent RSV infection compared with other RSV infection and entire cohort}. 	
...
(C) Principal component analysis (PCA) PCs1-3 with labels indicating repeat/persistent infections from different phylogenetic clades.
(D) Panel [i] summarises every pairwise genetic distance between every viral sequence.
Genetic invariance in repeat/persistent infections separated by at least 15 days compared to other genetic variation within clades  
...
\begin{figure}[ht] \hspace{-0.5cm} \begin{center}
	...
	\caption{\textbf{Supplemental: Publicly available RSV sequence data for $>30$ years}. (A) Global sample collection per year. (B) Variant associated with persistent infection tracked in public data. (C) \% variance explained per year for all G protein amino acid variants from 1990-2022} 
