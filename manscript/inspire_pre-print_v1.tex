...
A number of host features have been previously shown to influence infection susceptibility and were therefore included as covariates in our analysis [ref]. %(cite Rosas-Salazar).
...
self-reported race/ethnicity, child-care attendance, living with siblings [ref]. %(cite Rosas-Salazar).
...
\citep{fellay2020exploring}.  % temp use this citation but switch to Mack's if available. % \citep{mack hbv, n=400}.
